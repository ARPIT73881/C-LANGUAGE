// Write a program to find whether a student is pass or fail , if it requires total 40% marks and atleast 33% marks in each subject ( subjects - physics , chemistry , maths)
#include <stdio.h>
